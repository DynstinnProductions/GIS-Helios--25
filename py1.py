...
heading = tk.Label(root, text="Pomodoro Timer", font=("sf_Font", 48), fg="black")
...
start_button = tk.Button(root, text="Start Pomodoro", command=start_timer, font=("SF Pro", 24), fg="black")
start_button.pack(pady=20)

stop_button = tk.Button(root, text="Stop Pomodoro", command=stop_timer, font=("SF Pro", 24), fg="black")
